...
end lpf_peak_hold_if;

architecture Behavioral of lpf_peak_hold_if is

--    signal ad_data_lpf_crnt : std_logic_vector(31 downto 0);
--    signal ad_data_lpf_peak_tmp : std_logic_vector(31 downto 0);
